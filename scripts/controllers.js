'use strict';
   ...
   angular.module('confusionApp')
         ...
         .controller('MenuController', ['$scope', 'menuFactory', function($scope, menuFactory) {
            ...
            $scope.select = function(setTab) {
                ...
                if (setTab === 2) {
                    ...
                    $scope.filtText = "Hyderabadi Biryani";
                }
                else if (setTab === 4) {
                    $scope.filtText = "Goat Specialties";
                }

                else if (setTab === 5) {
                    $scope.filtText = "Chicken Specialties";
                }
        ...
        .controller('ContactController', ['$scope', function($scope) {
            ...
            $scope.feedback = {mychannel:"", firstName:"", lastName:"", agree:true, email:"" };
